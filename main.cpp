...
//  project4
//
//  Created by Zeming Zhao on 2018/11/18.
//  Copyright © 2018年 Zeming Zhao. All rights reserved.
//
...
int main()
{
    ...
    for(i = 0; i < n; i++)
    {
        num = (rand()%1000);//I set them between 0-999 because you didn't mention the range.
        cout<<"\n elements to be sorted: "<< num;
